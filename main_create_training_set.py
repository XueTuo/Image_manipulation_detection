...
#file = open('/opt/ocr/Image_manipulation_detection/data/VOCdevkit2012/VOC2012/ImageSets/Segmentation/trainval_catch.txt','w',encoding='utf-8')
# file.write(str(image_index))

def generate_seg_img_map():
    map = {}
    for idx1,i in enumerate(seg_index):
        #isContain=False
        for idx2,j in enumerate(image_index):
            if i == j:
                map[idx1] = idx2
                #print(idx1,idx2)
